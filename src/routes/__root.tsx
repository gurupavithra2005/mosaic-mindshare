  ...
  head: () => ({
    meta: [
      ...
      { title: "MOSAIC — Social, without the endless scroll" },
      {
        name: "description",
        content:
          "MOSAIC is a frontend-only social surface where ideas connect as tiles instead of stacking into a feed.",
      },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "WebSite",
          name: "MOSAIC",
          url: "https://mosaic-mindshare.lovable.app",
          description: "Social, without the endless scroll.",
        }),
      },
    ],
  }),
